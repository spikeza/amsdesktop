...
namespace AMSDesktop.DAL.Database {
    ...
    public partial class amsdbDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string Username, string Firstname, string Lastname, string Password, string Salt) {
...
namespace AMSDesktop.DAL.Database.amsdbDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Users` WHERE ((`Username` = ?) AND ((? = 1 AND `Firstname` IS NULL) OR (`Firstname` = ?)) AND ((? = 1 AND `Lastname` IS NULL) OR (`Lastname` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Salt` IS NULL) OR (`Salt` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Username`, `Firstname`, `Lastname`, `Password`, `Salt`) VAL" +
                "UES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Users` SET `Username` = ?, `Firstname` = ?, `Lastname` = ?, `Password` = ?, `Salt` = ? WHERE ((`Username` = ?) AND ((? = 1 AND `Firstname` IS NULL) OR (`Firstname` = ?)) AND ((? = 1 AND `Lastname` IS NULL) OR (`Lastname` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Salt` IS NULL) OR (`Salt` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AMSDesktop.Properties.Settings.Default.amsdbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Firstname, Lastname, [Password], Salt FROM Users";
        ...
        public virtual int Fill(amsdbDataSet.UsersDataTable dataTable) {
        ...
        public virtual amsdbDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            amsdbDataSet.UsersDataTable dataTable = new amsdbDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(amsdbDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Username, string Original_Firstname, string Original_Lastname, string Original_Password, string Original_Salt) {
        ...
        public virtual int Insert(string Username, string Firstname, string Lastname, string Password, string Salt) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Firstname, string Lastname, string Password, string Salt, string Original_Username, string Original_Firstname, string Original_Lastname, string Original_Password, string Original_Salt) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Firstname, string Lastname, string Password, string Salt, string Original_Username, string Original_Firstname, string Original_Lastname, string Original_Password, string Original_Salt) {
            return this.Update(Original_Username, Firstname, Lastname, Password, Salt, Original_Username, Original_Firstname, Original_Lastname, Original_Password, Original_Salt);
        }
    }
